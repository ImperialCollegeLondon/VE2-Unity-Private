...
public class VRPortalRenderer: MonoBehaviour/*, IPlayerInputHandler*/{
	[Header("Camera")]
	//[SerializeField] public Camera sourceCamOverride = null; //We're jusat using the VR rig's camera
	...
	[SerializeField] string eyeTexLParam = "_EyeTexL";
	[SerializeField] string eyeTexRParam = "_EyeTexR";
	[SerializeField] string eyeViewMatLParam = "_EyeViewMatrixL";
	[SerializeField] string eyeViewMatRParam = "_EyeViewMatrixR";
	[SerializeField] string eyeProjMatLParam = "_EyeProjMatrixL";
	[SerializeField] string eyeProjMatRParam = "_EyeProjMatrixR";
	...
	*/
	...
	void renderToTexture(RenderTexture rt, Pose eyePose, out Matrix4x4 viewMat, out Matrix4x4 projMat){
		...
		var srcCam = Camera.main;//TODO: VR
