...
namespace VE2.Core.VComponents.Tests
{
    ...
    internal class V_ToggleActivatableProviderStub : IV_ToggleActivatable, IRangedClickInteractionModuleProvider, ICollideInteractionModuleProvider
    {
        ...
        ICollideInteractionModule ICollideInteractionModuleProvider.CollideInteractionModule => _ToggleActivatableService.ColliderInteractionModule;
        IRangedInteractionModule IRangedInteractionModuleProvider.RangedInteractionModule => _ToggleActivatableService.RangedClickInteractionModule;
        #endregion

        internal ToggleActivatableService _ToggleActivatableService = null;
