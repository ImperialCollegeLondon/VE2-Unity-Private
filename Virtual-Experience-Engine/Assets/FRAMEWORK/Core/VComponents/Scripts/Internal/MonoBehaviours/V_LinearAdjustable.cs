...
{
    internal partial class V_LinearAdjustable : IV_LinearAdjustable
    {
    ...
    internal partial class V_LinearAdjustable : BaseSyncableVComponent, IRangedGrabInteractionModuleProvider
    {
        ...
        private void OnEnable()
        {
            ...
            _idWrapper = new();
            _vComponentID = "LinearAdjustable-";
