...
namespace VE2.Core.VComponents.Internal
{
    ...
    internal class LinearAdjustableService
    {
            ...
            IWorldStateSyncableContainer worldStateSyncableContainer, IGrabInteractablesContainer grabInteractablesContainer, HandInteractorContainer interactorContainer)
        {
            ...
            _GrabbableStateModule = new(grabbableState, config.GrabbableStateConfig, $"{id}", worldStateSyncableContainer, interactorContainer, RangedAdjustableInteractionModule);
