...
namespace VE2.Core.VComponents.Internal
{
    ...
    internal class RotationalAdjustableService
    {
        ...
        public RotationalAdjustableService(List<IHandheldInteractionModule> handheldInteractions, RotationalAdjustableConfig config, AdjustableState adjustableState, VE2Serializable grabbableState, IGameObjectIDWrapper id, IGameObjectIDWrapper adjustableStateIDWrapper,
