...
{
    internal class V_ToggleActivatable : MonoBehaviour, IV_ToggleActivatable, IRangedGrabPlayerInteractableIntegrator, ICollidePlayerInteractableIntegrator
    {
        ...
        private void OnEnable()
        {
            ...
            _service = new ToggleActivatableService(_config, _state, id, VE2CoreServiceLocator.Instance.WorldStateModulesContainer);
        }
