...
{
    public class V_RotationalAdjustable : MonoBehaviour, IV_RotationalAdjustable, IRangedGrabPlayerInteractableIntegrator
    {
        ...
        IFreeGrabbableStateModule IV_RotationalAdjustable._FreeGrabbableStateModule => _service.FreeGrabbableStateModule;
