...
{
    [SerializeField] private InterfaceReference<IV_RotatingAdjustable> leverX;
    [SerializeField] private InterfaceReference<IV_RotatingAdjustable> leverZ;
    ...
    void Update()
    {
        Vector3 xVector = Vector3.right * leverX.Interface.Value * Time.deltaTime * MOVE_SPEED;
        Vector3 zVector = Vector3.forward * leverZ.Interface.Value * Time.deltaTime * MOVE_SPEED;
