...
namespace VE2_NonCore_FileSystem
{
    public abstract class V_FileSystemIntegrationBase : MonoBehaviour
    {
        ...
        public List<IRemoteFileTaskInfo> GetQueuedTasks() => _queuedTasks.Cast<IRemoteFileTaskInfo>().ToList();
        public List<IRemoteFileTaskInfo> GetCompletedTasks() => _completedTasks.Cast<IRemoteFileTaskInfo>().ToList();
        #endregion
